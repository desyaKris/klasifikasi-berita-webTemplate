          ...
          <div class="boxed-grey">
            ...
            <form align="center" id="register" class="form-horizontal" action="{{url('predict.store')}}">
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="form-group">
                    <label for="exampleSpam">
                                Teks Berita</label>
                    <textarea type="text" class="form-control" name="text_spam" id="Text_spam" placeholder="masukkan teks berita disini, tanpa tanda petik(" ")" data-rule="minlen:10" data-msg="Please enter at least 8 chars of Text" /></textarea>
                ...
                <br>
                <div class="col-md-6">
                  <label for="examplePredict" name="result">Hasil Prediksi</label>
                ...
                <script type="text/javascript">
                  $(document).ready(function(){
                    ...
                    $('#predict').click(function(){
                      ...
                      $.ajax({
                        type: "POST",
                        url:"https://api-klasifikasi-berita.herokuapp.com/input/task",
                        data:'{"text":"'+text+'"}',
